...
class ModelSlimMoEMethod(FusedMoEMethodBase):
    ...
    def get_moe_method(
        ...
        elif is_moe_w8a8_mxfp8:
            logger.info_once("Using ModelSlimW8A8MxFp8MoE")
            return ModelSlimW8A8MxFp8MoE(quant_config)
        else:
            logger.warning(
...
class ModelSlimW8A8MxFp8MoE(ModelSlimMoEMethod):
